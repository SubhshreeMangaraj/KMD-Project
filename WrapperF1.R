...
getParamSet(lrnr)
ps <- makeParamSet(makeIntegerParam("k",       lower = 1, upper = 10,trafo = function(x) 2^x),
                   makeNumericParam("distance",lower = 1, upper = 10,trafo = function(x) 2^x)
)
...
write.csv(df_val_w1r1, file = "/home/mangaraj/Documents/output/df_val_w1r1.csv")
write.csv(df_tune_w1r1, file = "/home/mangaraj/Documents/output/df_val_w1r1_data.csv")
...
nwln<- list(Observation= "mse", Value = res_r3)
df_val_w1r3 = rbind(df_val_w1r3,nwln, stringsAsFactors=FALSE)
...
#Capturing best values of hyperparameter after tuning
df_val_w1c2<-data.frame(Observation=character(), Value=character())

nwln<- list(Observation= "No. of Features", Value = (ncol(df_tune_w1c2)-1))
...
nwln<- list(Observation= "Accuracy", Value = res_w1c2)
df_val_w1c2 = rbind(df_val_w1c2,nwln, stringsAsFactors=FALSE)
...
nwln<- list(Observation= "No. of Features", Value = (ncol(df_tune_w1c3)-1))
...
nwln<- list(Observation= "Accuracy", Value = res_w1c3)
df_val_w1c3 = rbind(df_val_w1c3,nwln, stringsAsFactors=FALSE)
...
#Capturing best values of hyperparameter after tuning
df_val_w2r1<-data.frame(Observation=character(), Value=character())

nwln<- list(Observation= "No. of Features", Value = (ncol(df_tune_w2r1)-1))
...
#Capturing best values of hyperparameter after tuning
df_val_w2r2<-data.frame(Observation=character(), Value=character())

nwln<- list(Observation= "No. of Features", Value = (ncol(df_tune_w2r2)-1))
...
nwln<- list(Observation= "mse", Value = res_w2r2)
df_val_w2r2 = rbind(df_val_w2r2,nwln, stringsAsFactors=FALSE)
...
#Capturing best values of hyperparameter after tuning
df_val_w2r3<-data.frame(Observation=character(), Value=character())
...
#Capturing best values of hyperparameter after tuning
df_val_w2c1<-data.frame(Observation=character(), Value=character())
...
nwln<- list(Observation= "Accuracy", Value = res_w2c1)
df_val_w2c1 = rbind(df_val_w2c1,nwln, stringsAsFactors=FALSE)
...
#Capturing best values of hyperparameter after tuning
df_val_w2c2<-data.frame(Observation=character(), Value=character())

nwln<- list(Observation= "No. of Features", Value = (ncol(df_tune_w2c2)-1))
...
nwln<- list(Observation= "Accuracy", Value = res_w2c2)
df_val_w2c2 = rbind(df_val_w2c2,nwln, stringsAsFactors=FALSE)
...
#Capturing best values of hyperparameter after tuning
df_val_w2c3<-data.frame(Observation=character(), Value=character())

nwln<- list(Observation= "No. of Features", Value = (ncol(df_tune_w2c3)-1))
...
nwln<- list(Observation= "Accuracy", Value = res_w2c3)
df_val_w2c3 = rbind(df_val_w2c3,nwln, stringsAsFactors=FALSE)
...
#Capturing best values of hyperparameter after tuning
df_val_w3r1<-data.frame(Observation=character(), Value=character())
...
#Capturing best values of hyperparameter after tuning
df_val_w3r2<-data.frame(Observation=character(), Value=character())

nwln<- list(Observation= "No. of Features", Value = (ncol(df_tune_w3r2)-1))
...
nwln<- list(Observation= "mse", Value = res_w3r2)
df_val_w3r2 = rbind(df_val_w3r2,nwln, stringsAsFactors=FALSE)
...
#Capturing best values of hyperparameter after tuning
df_val_w3r3<-data.frame(Observation=character(), Value=character())

nwln<- list(Observation= "No. of Features", Value = (ncol(df_tune_w3r3)-1))
...
nwln<- list(Observation= "mse", Value = res_w3r3)
df_val_w3r3 = rbind(df_val_w3r3,nwln, stringsAsFactors=FALSE)
...
#Capturing best values of hyperparameter after tuning
df_val_w3c1<-data.frame(Observation=character(), Value=character())
...
nwln<- list(Observation= "Accuracy", Value = res_w3c1)
df_val_w3c1 = rbind(df_val_w3c1,nwln, stringsAsFactors=FALSE)
...
#Capturing best values of hyperparameter after tuning
df_val_w3c2<-data.frame(Observation=character(), Value=character())

nwln<- list(Observation= "No. of Features", Value = (ncol(df_tune_w3c2)-1))
...
nwln<- list(Observation= "Accuracy", Value = res_w3c2)
df_val_w3c2 = rbind(df_val_w3c2,nwln, stringsAsFactors=FALSE)
...
#Capturing best values of hyperparameter after tuning
df_val_w3c3<-data.frame(Observation=character(), Value=character())

nwln<- list(Observation= "No. of Features", Value = (ncol(df_tune_w3c3)-1))
...
nwln<- list(Observation= "Accuracy", Value = res_w3c3)
df_val_w3c3 = rbind(df_val_w3c3,nwln, stringsAsFactors=FALSE)
